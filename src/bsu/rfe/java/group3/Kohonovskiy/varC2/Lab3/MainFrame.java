...
public class MainFrame extends JFrame {
    ...
    // пользователю если тот не собирается сохранять данные в файл private
    ...
    public MainFrame(Double[] coefficients) {
        ...
        // Добавить "клей" C1-H7
        hboxRange.add(Box.createHorizontalGlue());
        // Установить предпочтительный размер области
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            // Если преобразование невозможно - сообщить об ошибке и завершится
